...
- (void)viewDidLoad
{
    ...
    [manager GET:url parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        [self setTableOuter:(int)data.count];
...
-(void)setTableOuter:(NSUInteger)noOfOuterRows
{
    ...
    {
        Snappvote* snappvote = [data objectAtIndex:i-1];
        ...
        labelOnOuter.text = [NSString stringWithFormat:@"Process no: %@", snappvote.title];
        ...
        UIImageView *imageViewFOrOuterTable = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 400, 44)];
